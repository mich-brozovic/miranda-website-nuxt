				...
				<a href="mailto:info@mirandamedia.cz" class="project-mail">
					<svg width="25" height="24" viewBox="0 0 25 24" fill="none" xmlns="http://www.w3.org/2000/svg">
						<path
							...
							stroke-linecap="round"
							stroke-linejoin="round" />
						<path d="M22.0023 6L12.0023 13L2.00232 6" stroke="white" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" />
					</svg>
			...
			<div class="column form-col">
				<form>
					...
					<div class="form-row">
						...
						<label for="consent">
							<strong>Odesláním</strong> souhlasíte s <NuxtLink to="/ochrana-osobnich-udaju">Podmínkami zpracování osobních údajů</NuxtLink>.
						</label>
					</div>
