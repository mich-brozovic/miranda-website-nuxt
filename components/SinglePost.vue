<template>
	<article class="post">
		<NuxtLink :to="`/clanky/${item.attributes.slug}`" class="post__link">
			<div class="post__image">
				...
				<div class="post__tags">
					<span v-for="(tag, index) in item.attributes.kategorie_clankus.data" :key="index">
						{{ tag.attributes.nazev }}
					</span>
				</div>
			</div>
			<div class="post__meta">
				<span v-if="item.attributes.read_duration" class="read-duration">
					<svg width="16" height="16" viewBox="0 0 16 16" fill="none" xmlns="http://www.w3.org/2000/svg">
						<path
							...
							fill="#222E27" />
						<path d="M8.66634 4.66663H7.33301V8.27596L9.52834 10.4713L10.471 9.52863L8.66634 7.72396V4.66663Z" fill="#222E27" />
					</svg>
					{{ item.attributes.read_duration }}
				</span>
				<span v-if="item.attributes.publishedAt" class="published-date">
					<svg width="16" height="16" viewBox="0 0 16 16" fill="none" xmlns="http://www.w3.org/2000/svg">
						<path
				...
				<span v-if="item.attributes.autor.data.attributes.jmeno" class="author">
