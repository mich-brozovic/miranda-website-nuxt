<template>
	<main>
		<HeroBig :imgUrl="'/soutez-hero.jpg'">
			<h1>
				Soutěž o<br />
		...
		<section id="scroll" ref="pageNavBar" class="page-nav">
			<div class="page-nav__wrapper container">
				<ul>
					...
					<li>
						<a href="#rewards" :class="{ '--active': activeSection === 'rewards' }">O co se soutěží</a>
					</li>
					<li>
						<a href="#participate" :class="{ '--active': activeSection === 'participate' }">Jak se zúčastnit</a>
					</li>
					<li>
		...
		<section id="registration" class="registration">
			<div class="registration__wrapper container">
				...
				<form v-else @submit.prevent="sendForm" class="registration__form" id="registration-form" method="post">
					...
					<fieldset class="registration__column registration__column--right">
						...
						<input
							...
							id="development"
							name="development"
							value="Rozvoj e-shopu"
							:ref="form.EshopDevelopment" />
						...
						<input
							...
							id="design"
							name="design"
							value="Grafika a design"
							:ref="form.graphicDesign" />
						...
						<input
							...
							id="product-photos"
							name="product-photos"
							value="Produktové fotografie"
							:ref="form.productPhotos" />
					...
					<div class="registration__submit buttons-wrapper">
						<button type="submit" class="btn btn-third">
							<span data-hover="Registrovat do soutěže">Registrovat do soutěže</span>
						</button>
						<input
							class="visually-hidden"
							type="checkbox"
		...
		<section id="rewards" class="rewards container">
			<h2 class="rewards__title">O co se soutěží?</h2>
			<div class="rewards__wrapper">
				<div class="rewards__image">
					<img src="/Rituals-soutez.png" alt="Rituals" />
				</div>
				<div class="rewards__content">
					<div class="rewards__card">
						<div class="rewards__headline">
							<span>1.místo</span>
							<h3>Unikátní design na míru Vašemu e-shopu</h3>
						</div>
						<p>
							Grafický design připravený na míru Vašemu e-shopu dokáže zvednout obraty až o desítky procent! Naši seniorní
							grafici pro Vás připraví unikátní návrh hlavní strany, kategorie a detailu produktu v desktopové a mobilní verzi
							včetně implementace na Váš Shoptet.
						</p>
						<div class="buttons-wrapper" style="margin-top: 20px">
							<BtnSecondary url="/pripadove-studie" text="Prohlédnout případové studie" />
						</div>
					</div>
					<div class="rewards__card">
						<div class="rewards__headline">
							<span>2. místo</span>
							<h3>3 měsíce správy PPC výkonnostních kampaní Google a Sklik + kompletní audit.</h3>
						</div>
						<p>
							Kompletní správa Vašich PPC kampaní na 3 měsíce zdarma včetně detailního auditu! Pomůžeme Vám získat více
							zákazníků a dodáme výkon Vašemu e-shopu! Bez podmínek, bez závazků!
						</p>
						<div class="buttons-wrapper" style="margin-top: 20px">
							<BtnSecondary url="/pripadove-studie" text="Prohlédnout případové studie" />
						</div>
					...
					<div class="rewards__card">
						<div class="rewards__headline">
							<span>3. - 10. místo</span>
							<h3>Poukaz v hodnotě 3000 Kč na produktové fotografie</h3>
						</div>
						<div class="buttons-wrapper" style="margin-top: 20px">
							<BtnSecondary url="https://www.produktovefotografie.cz" text="www.produktovefotografie.cz" />
						</div>
					</div>
				</div>
			</div>
		...
		<section id="participate" class="participate">
			<div class="participate__wrapper container">
				<h2 class="participate__title">Jak se zůčastnit</h2>
		...
		<section id="announcement" class="announcement">
			<h2 class="announcement__title">Seznam výherců</h2>
			<div class="announcement__content">
				<table>
					<tr>
						<td>1.</td>
						<td>Radek Miklik</td>
						<td>www.inteashop.cz</td>
					...
					<tr>
						...
						<td>www.drevoslaskou.cz</td>
						<td>Poukaz v hodnotě 3000 Kč na produktové fotografie.</td>
					</tr>
					<tr>
						<td>4.</td>
						<td>Lea Čubrová</td>
						<td>www.dvaandele.cz</td>
						<td>Poukaz v hodnotě 3000 Kč na produktové fotografie.</td>
					</tr>
					<tr>
						<td>5.</td>
						<td>Barbora Synková</td>
						<td>www.baven.cz</td>
						<td>Poukaz v hodnotě 3000 Kč na produktové fotografie.</td>
					</tr>
					<tr>
						<td>6.</td>
						<td>Lukáš Prokýšek</td>
						<td>www.gentlemensbrand.cz</td>
						<td>Poukaz v hodnotě 3000 Kč na produktové fotografie.</td>
					</tr>
					<tr>
						<td>7.</td>
						<td>Pecha Filip</td>
						<td>www.laser-design.cz</td>
						<td>Poukaz v hodnotě 3000 Kč na produktové fotografie.</td>
					</tr>
					<tr>
						<td>8.</td>
						<td>Lucie Osvaldová</td>
						<td>www.fleppi.cz</td>
						<td>Poukaz v hodnotě 3000 Kč na produktové fotografie.</td>
					</tr>
					<tr>
						...
						<td>www.juvelora.cz</td>
						<td>Poukaz v hodnotě 3000 Kč na produktové fotografie.</td>
					</tr>
					<tr>
						<td>10.</td>
						<td>Sabina Vlčková</td>
						<td>www.finelines.cz</td>
						<td>Poukaz v hodnotě 3000 Kč na produktové fotografie.</td>
					</tr>
				</table>
			</div>
		...
		<section id="competition-rules" class="competition-rules">
			...
			<div class="competition-rules__text" :class="{ 'competition-rules__text--expanded': isExpanded }">
				...
				<p>Soutěže se mohou zúčastnit všichni zájemci starší 18 let s trvalým bydlištěm v České republice a Slovenské republice.</p>
				<strong>Registrace do soutěže</strong>
				<p>
					Účastníci soutěže se musí zaregistrovat prostřednictvím online formuláře na internetových stránkách soutěže nebo na
					veletrhu Reshoper 2023. Registrace je otevřena od 17. 5. do 17. 6. Každý účastník se může zaregistrovat pouze jednou s
					jedním e-shopem.
				</p>
				<strong>Slosování výherce</strong>
				<p>
					Výherce bude vybrán prostřednictvím slosování. Slosování se uskuteční dne 18. 7. 2023 za účasti notáře. Výherce bude
					informován prostřednictvím e-mailu nebo telefonu nejpozději do 31. 7. 2023.
				</p>
				<strong>Ceny:</strong>
				<ol>
					<li>
					...
					<li>místo: Správa výkonnostních kampaní Google a Sklik na 3 měsíce zdarma.</li>
					<li>až 10. místo: Poukaz v hodnotě 3000 Kč na produktové fotografie.</li>
				</ol>
				<strong>Unikátní grafický návrh</strong>
				<p>
					Výherce grafického návrhu bude mít možnost spolupracovat s firmou MirandaMedia při tvorbě grafického návrhu na míru pro
					jeho e-shop na platformě Shoptet nebo Shoptet Premium. Navrhovaný design se bude skládat z hlavní strany, kategorie a
					detailu produktu v mobilní a desktopové verzi. Výherce dostane k dispozici až 2 iterace s pro případné požadavky na
					změny a úpravy grafického návrhu. Grafický návrh bude následně nakódován v plně responzivní verzi na stránky výherního
					e-shopu.
				</p>
			</div>
			<div class="competition-rules__buttons">
				<button class="competition-rules__button" @click.prevent="isExpanded = !isExpanded">
					{{ isExpanded ? 'Přečíst méně' : 'Přečíst více' }}
				</button>
			</div>
		</section>
...
<script setup>
	...
	/*const pageNavBar = ref(null);
const positionY = ref(0);
let isFixed = ref(false);

onMounted(() => {
  positionY.value = pageNavBar.value.getBoundingClientRect().top;
  window.addEventListener('scroll', function () {
    let scroll = window.pageYOffset;

    if (scroll >= positionY.value) {
      isFixed = true;
    }
    if (scroll < positionY.value) {
      isFixed = false;
	...
	onMounted(() => {
		pageNavItems.value = Array.from(pageNavBar.value.querySelectorAll('a[href^="#"]'))
		window.addEventListener('scroll', () => {
			const scroll = window.pageYOffset + document.documentElement.clientHeight / 2

			for (const section of document.querySelectorAll('section[id]')) {
				const positionTop = section.getBoundingClientRect().top + window.pageYOffset
				const id = section.id
...
<style lang="scss" scoped>
	...
	body {
		background: url('/background-cubes-3.png'), url('/background-cubes-4.png'), url('/background-cubes-5.png');
	...
	.rewards__headline {
		...
		h3 {
			margin: 0;
			font-size: clamp(rem(16), 2.5vw, rem(24));
		}
		margin-bottom: 20px;
	}
	/* ---------------------- */
	...
	.participate {
		...
		height: auto;
		margin-inline: auto;
		background-image: url('/background-participate.png');
		background-position: center;
	...
	.participate__card {
		...
		h3 {
			...
			gap: 10px;
			span {
				font-size: clamp(rem(24), 2.5vw, rem(32));
				font-weight: 700;
				color: $color-green;
			}
		}
