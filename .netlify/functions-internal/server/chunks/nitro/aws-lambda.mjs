...
const _9or254 = lazyEventHandler(() => {
  const ipxOptions = {
...
const _lazy_oTbgcP = () => import('../handlers/renderer.mjs');

const handlers = [
  { route: '/__nuxt_error', handler: _lazy_oTbgcP, lazy: true, middleware: false, method: undefined },
  { route: '/_ipx/**', handler: _9or254, lazy: false, middleware: false, method: undefined },
  { route: '/**', handler: _lazy_oTbgcP, lazy: true, middleware: false, method: undefined }
];
